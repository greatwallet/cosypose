...
from ..training.train_pose_custom import train_pose
...
def make_cfg_custom(args):
    ...
    # tuple: (ds_name, repeat time) 
    cfg.train_ds_names = [('kwai.tracking.train', 1)]
    cfg.val_ds_names = ['kwai.tracking.test', ]
    cfg.val_epoch_interval = 10
    cfg.test_ds_names = ['kwai.tracking.test', ]
    cfg.test_epoch_interval = 30
    cfg.n_test_frames = None

    cfg.input_resize = (1080, 1920)
    cfg.rgb_augmentation = True
    cfg.background_augmentation = True
    cfg.gray_augmentation = False
