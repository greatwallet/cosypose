...
from cosypose.datasets.pose_dataset import PoseDataset, PoseTrackingDataset
...
from .pose_forward_loss import h_pose, h_pose_custom
from .pose_models_cfg import create_model_pose_custom, check_update_config
...
from cosypose.datasets.kwai import KwaiTrackingDataset
...
def train_pose(args):
    ...
    for epoch in range(start_epoch, end_epoch):
        ...
        h = functools.partial(h_pose_custom, model=model, cfg=args, n_iterations=args.n_iterations,
